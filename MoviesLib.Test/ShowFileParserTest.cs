...
namespace MoviesLib.Test
{
    ...
    public class ShowFileParserTest
    {
        ...
        public void ExtraireQualiteDuTitre_When_QualiteEstWEBDL_Then_WEBDL()
        {
            ...
            string titreSeries = "Gotham.S03E19.SUBFRENCH.720p.WEB-DL.DD5.1.x264-ARK";
            ...
            Assert.AreEqual("720p", resultParser.Resolution);
            Assert.AreEqual("WEB-DL", resultParser.Qualite);
        ...
        public void ExtraireNomDeSerieDuTitre_OuLeTitreEstAuMilieu()
        {
            ...
            string titreSeries = "12.Monkeys.S03E05.Causality.FASTSUB.VOSTFR.1080p.WEB-DL.AAC.2.0.x264.GuS2SuG";
        ...
        public void ExtraireLangueDuTitre_When_VoSousTitreFrench_And_FrenchIsSelected_Then_FRENCH()
        {
            ...
            string titreSeries = "Crazy.Ex-Girlfriend.S02E06.FRENCH.720p.WEB-DL.DD5.x264-otm";
